...
- **ActiveMQ** — `verify_certificate` (default on), same convention as Solace/RabbitMQ — one credential set (basic auth against Jolokia) covers both monitoring and peek.
